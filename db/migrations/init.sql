...
ALTER TABLE reports ADD COLUMN IF NOT EXISTS platforms TEXT[] NOT NULL DEFAULT '{}';
ALTER TABLE reports ADD COLUMN IF NOT EXISTS categories TEXT[] NOT NULL DEFAULT '{}';
ALTER TABLE reports ADD COLUMN IF NOT EXISTS format TEXT NOT NULL DEFAULT 'json';
